...
Zapisujemy w jeden duzy plik pdf
...
pliki_tab_all %>%
  ...
  theme_bw() +
  labs(x = "Data", y = "Liczba zachorowań", 
       title = "Liczba zachorowań według ognisk w Małopolsce",
...
ggsave(plot = p, filename = "../figs/ogniska-malopolska-total.png", width = 12, height = 6)
```
...
pliki_tab_all %>%
  ...
  theme_bw() +
  labs(x = "Data", y = "Liczba zachorowań", 
       title = "Dzienna liczba zachorowań według ognisk w Małopolsce",
       subtitle = "Opracowanie na podstawie raportów Wojewódzkiej Stacji Sanitarno-Epidemiologicznej w Krakowie",
       caption = 
...
pliki_tab_all %>%
  ...
  labs(x = "Data", y = "Odsetek zachorowań", fill = "Ognisko",
       title = "Struktura dziennych zachorowań według ognisk w Małopolsce",
       subtitle = "Opracowanie na podstawie raportów Wojewódzkiej Stacji Sanitarno-Epidemiologicznej w Krakowie",
       caption = 
       "Wyjaśnienia: Dane od 02.09.2020 ponieważ od 01.09.2020 zmieniono metodykę reportowania. Dla 01.09.2020 nie ma raportu w pdf.
       Skróty: ZOLe -- Zakłady Opiekuńczo-Lecznicze, DPSy -- Domy Pomocy Społecznej, Kwarantanna -- dotyczy stwierdzenia zachorowania w trakcie odbywania kwarantanny (po wcześniejszym kontakcie).
